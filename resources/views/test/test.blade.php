...
<html lang="en">
    ...
    <head>
        ...
        <!-- estilo personalizado radio button aumentado por @analia -->
        <link href="{{asset('css/estilo-personalizado-radiobutton.css')}}" type="text/css" rel="stylesheet">
                    ...
                    <div class="col-sm-12 ">
                        <div class="blog-author">
                            <div class="blog-title">
                                <h4 class="text-center text-justify"><span class="color2">PREGUNTA NRO. 5</span></h4>
                            ...
                            <div class="author-contact">
                                <div class="pull-left">
                                    <button class="btn-announce pull-left"><i class="fa fa-hand-o-left"></i></button> 
                                </div>
                                <div class="pull-right">
                                    <button class="btn-announce pull-right"><i class="fa fa-hand-o-right"></i></button>
                                </div>
                            </div>
                        </div>   
                    </div>
